  ...
  <table class="table w-full">
    ...
    <tfoot>
        <tr>
            <td colspan="14">
                <div class="btn-group">
                    <button class="btn btn-primary" @click="firstPage(data.first_page_url)">First Page</button>
                    ...
                    <button class="btn btn-primary" @click="firstPage(data.last_page_url)">Last Page</button>
                </div>
            </td>
        </tr>
    </tfoot>
