...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('endline_measure_return_chart', function (Blueprint $table) {
            $table->integer('id', true);
            $table->integer('inspection_measure_item_id')->nullable()->index('inspection_measure_item_id');
            $table->integer('measure_profile_chart_id')->nullable()->index('measure_profile_chart_id');
    ...
    {
        Schema::dropIfExists('endline_measure_return_chart');
    }
};
