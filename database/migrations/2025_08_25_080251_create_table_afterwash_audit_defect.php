...
class CreateTableAfterwashAuditDefect extends Migration
{
    public function up(): void
    {
        Schema::create('afterwash_audit_defect', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('afterwash_audit_defect');
    }
}
