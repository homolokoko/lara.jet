...
class CreateInspFinishingProfile extends Migration
{
    public function up(): void
    {
        Schema::create('insp_finishing_profile', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('insp_finishing_profile');
    }
}
