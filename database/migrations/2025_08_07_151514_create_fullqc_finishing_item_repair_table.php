...
class CreateFullqcFinishingItemRepairTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fullqc_finishing_item_repair', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fullqc_finishing_item_repair');
    }
}
