...
class CreateTableInspEmbellishmentItemDefect extends Migration
{
    public function up(): void
    {
        Schema::create('insp_embellishment_item_defect', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('insp_embellishment_item_defect');
    }
}
