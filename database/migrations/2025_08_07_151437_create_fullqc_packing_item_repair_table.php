...
class CreateFullqcPackingItemRepairTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fullqc_packing_item_repair', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fullqc_packing_item_repair');
    }
}
