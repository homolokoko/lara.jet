...
class CreateFullqcAfterwashProfileTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fullqc_afterwash_profile', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fullqc_afterwash_profile');
    }
}
