...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('inspection_style_information', function (Blueprint $table) {
            ...
            $table->string('production_desc')->nullable();
    ...
    {
        Schema::dropIfExists('inspection_style_information');
    }
};
