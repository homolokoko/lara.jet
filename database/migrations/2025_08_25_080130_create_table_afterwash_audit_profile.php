...
class CreateTableAfterwashAuditProfile extends Migration
{
    public function up(): void
    {
        Schema::create('afterwash_audit_profile', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('afterwash_audit_profile');
    }
}
