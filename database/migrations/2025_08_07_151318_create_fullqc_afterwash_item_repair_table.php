...
class CreateFullqcAfterwashItemRepairTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fullqc_afterwash_item_repair', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fullqc_afterwash_item_repair');
    }
}
