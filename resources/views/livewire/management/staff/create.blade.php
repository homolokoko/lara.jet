        ...
        <div class="flex flex-col gap-5">
            ...
            <div class="space-y-3">
                ...
                <select x-model="usr.edu_lvl" class="select select-bordered">
                    ...
                    <option value="i">Upper Secondary (Grades 10-12)</option>
                    <option value="ii">Diploma</option>
                    <option value="iii">Associate Degree</option>
                    <option value="iv">Bachelor's Degree</option>
                    <option value="v">Master's Degree</option>
                    <option value="vi">Doctorate/Ph.D.</option>
                </select>
            </div>
        </div>
