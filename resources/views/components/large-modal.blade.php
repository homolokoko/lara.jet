<div x-data="{ modalOpen: false }"
    ...
    <div x-show="modalOpen" class="fixed top-0 left-0 z-10 flex items-center justify-center w-screen h-screen" x-cloak>
            <div x-show="modalOpen"
                ...
                class="absolute inset-0 w-full h-full backdrop-blur-sm bg-base-50/70"></div>
            <div x-show="modalOpen"
                ...
                class="relative w-full border shadow-lg bg-base-50 border-neutral-200 max-w-7xl sm:rounded-lg">
