...
class Version extends Model
{
    ...
    protected $table = 'symmetric_version';
    protected $fillable = ['symmetric_header_id', 'symmetric_group_version_id', 'version_id'];
    ...
    {
        return $this->hasMany(\App\Models\Report\SymmetryCheckpoint\Result::class, 'symmetric_version_id', 'id');
    }
}
